    ...
    <section style={{ width: "100%", maxWidth: "none" }} className="relative w-full min-h-[410px] overflow-hidden border border-white/10 bg-[#191a20] p-5 sm:p-8 lg:p-10">
      ...
      <div className="relative z-10 flex min-h-[346px] max-w-[700px] flex-col">
        ...
        <div className="mt-auto">
          ...
          <div className="mt-7 flex flex-wrap gap-3"><Link href="/matchmaking" className="primary-button"><Crosshair className="h-4 w-4" />Find opponent</Link><Link href="/matchmaking" className="secondary-button"><Plus className="h-4 w-4" />Create room</Link></div>
        </div>
      </div>
